...
#
# This script is used to install EML AdminTool v{{VERSION}}.
...
echo "                                                                        "
echo "                                                                        "
echo "EML AdminTool v{{VERSION}} Installer"
echo "Copyright (c) 2026, GoldFrite"
echo "This script is under the GPL-3.0 license."
echo ""
echo "Having trouble installing? Join our Discord support server: https://emlproject.com/discord/other"
...
ORIGINS="http://localhost:8086,http://127.0.0.1:8086,http://$LOCAL_IP:8086"

if [ -n "$PUBLIC_IP" ]; then
  ORIGINS="$ORIGINS,http://$PUBLIC_IP:8086,https://$PUBLIC_IP:8086"
fi
